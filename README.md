...
| [TWZRD Agent Intel](https://intel.twzrd.xyz) | Solana agent trust scoring via MCP tools to score, resolve and verify AI agent wallets | No | Yes | Yes |
...
| [btcnode.uk](https://btcnode.uk) | Bitcoin data, fees, mempool, SEC insider trades and Reddit sentiment via x402 micropayments | No | Yes | Unknown |
...
| [Solematica](https://www.solematica.it/sviluppatori) | Compare Italian solar installer offers, energy prices and satellite roof data | No | Yes | No |
...
| [Astroworld](https://api.astroworldmc.com) | Minecraft data for mobs, biomes, items, structures, commands, versions and achievements | No | Yes | Yes |
...
| [MediaCraft AI](https://mediacraft-x402-api.onrender.com) | Chinese content review, EN-CN translation and SEO optimization with x402 payments | `apiKey` | Yes | Yes |
...
| [Warnely](https://warnely.com/developers) | Travel safety scores for 180 countries using government sources and live incident data | No | Yes | Yes |
...
| [BuyWhere](https://buywhere.ai) | Real-time product catalog for AI agents across merchants in seven countries | `apiKey` | Yes | Unknown |
